feature Album, :js do
  ...
  context 'Create' do
    ...
    context 'with valid values' do
      ...
      scenario 'with rich text content' do
      ...
      scenario 'with picture' do
        attach_file 'Picture', "#{Rails.root}/spec/fixtures/lebrijo.jpg"
        click_button 'Save'
        expect(page).to have_content @album_name

        persisted_album = Album.find_by(name: @album_name)
        expect(persisted_album.picture).to be_attached
      end
    end
